...
function SampleList(props) {
  ...
  const handleRenderOperator = (value, index, record) => {
    const { sampleInfo: { mailNo = '', sampleId = '', status = '' } = {} } = record;
    let text = '';
    if (status === 'invalid') {
      text = '查看';
    } else if (mailNo) {
    ...
    return (
      <a href={`${detailPage}&_hex_sampleId=${sampleId}`} className="view-btn" target="_blank" rel="noreferrer">
        {text}
      </a>
    );
  };
    ...
    <SampleBasicLayout className="sample-list-container">
      ...
      <div className="table-container">
        ...
        >
          ...
          <Table.Column title="创建时间" align="center" width={200} cell={handleRenderTime} />
