...
import { Button, Select, Table, Balloon, Icon, Pagination, Message, Timeline, Dialog } from '@alifd/next';
import dayjs from 'dayjs';
import Clipboard from '@/components/ClipBoard';
import { IconCopy } from '@/components/Icons';
import ProgressiveImage from '@/components/ProgressiveImage';
import AeSearchFilter from '../AeSearchFilter';
import PrintPreviewDialog from '../PrintPreviewDialog';
import { SML, ZJ, orderConstants, defaultParam, receiveStatusMap } from '../../constants';
import { orderTableactionMap } from '../../utils';
import actions from '@/service/actions';
import './index.scss';
import { checkWhiteList, isGray } from '../../api';
import CountDown from '@/components/CountDown';
import AeManufacturerDialog from '../AeManufacturerDialog';
...
export default (props) => {
  ...
  return (
    <>
      <AeSearchFilter setParams={hanldeSetParams} type={activeType} />
