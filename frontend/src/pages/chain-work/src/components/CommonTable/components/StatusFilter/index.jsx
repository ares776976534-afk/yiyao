...
function StatusFilter({
  ...
  labelMap = { name: 'name', code: 'code', subStatusList: 'subStatusList', quantity: 'quantity' },
  tabStyle,
  extra,
}) {
  ...
  const getData = () => {
    ...
    return fnOrList().then((data) => {
      ...
      const logName = data.find((item) => item.code === active)?.logName || null;
      if (logName) {
