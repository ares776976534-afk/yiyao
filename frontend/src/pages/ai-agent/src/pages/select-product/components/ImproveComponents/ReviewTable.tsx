...
const columns = [
  ...
  TITLE_COLUMN,
  {
    title: $t("global-1688-ai-app.select-product.ImproveComponents.ReviewTable.lm", "类目"),
    dataIndex: 'catePath',
    key: 'catePath',
    width: 240,
  },
  ...
  {
    title: $t("global-1688-ai-app.select-product.ImproveComponents.ReviewTable.comments", "评论数"),
    dataIndex: 'reviewCnt',
    key: 'reviewCnt',
  },
  {
