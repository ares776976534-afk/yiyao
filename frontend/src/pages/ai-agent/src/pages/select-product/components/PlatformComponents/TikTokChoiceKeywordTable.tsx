...
const columns = [
  {
    title: $t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.keyword", "关键词"),
    dataIndex: 'keyword',
    key: 'keyword',
  },
  {
    title: (
      <div>
        <span className="mr-1">{$t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.gjjhf", "改进机会分")}</span>
        <Tooltip title={$t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.gjjhf", "改进机会分")}>
  ...
  {
    title: $t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.krqgh", "关键词销售额趋势(近12个月) "),
  ...
  },
  {
    ...
    children: [
      {
        title: $t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.monthSales", "月销量"),
      ...
      {
        title: $t("global-1688-ai-app.select-product.PlatformComponents.TikTokChoiceKeywordTable.monthxse", "月销售额"),
        dataIndex: 'soldCnt30d',
        key: 'soldCnt30d',
        render: (text, record) => {
          return (<div>
