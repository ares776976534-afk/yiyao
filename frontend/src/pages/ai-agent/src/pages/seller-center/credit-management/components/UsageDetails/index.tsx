...
const UsageDetails: React.FC<FilterProps> = () => {
      ...
      <div className={styles.filterSection}>
        <div className={styles.filterGroup}>
          ...
          <Input
            ...
            placeholder={$t("global-1688-ai-app.seller-center.credit-management.UsageDetails.iRs", "输入Request ID……")}
        ...
        <div className={styles.filterGroup}>
          <div className={styles.dateRangeWrapper}>
            <div className={styles.dateRange}>
              <label className={styles.filterLabel}>{$t("global-1688-ai-app.seller-center.credit-management.UsageDetails.startTime", "开始时间")}</label>
              <DatePicker
                className={styles.dateInput}
                value={filters.startTime}
                onChange={(date) => handleFilterChange('startTime', date)}
                placeholder={$t("global-1688-ai-app.seller-center.credit-management.UsageDetails.qce", "请选择日期")}
                disabledDate={(current) => filters.endTime && current && current.isAfter(filters.endTime, 'day')}
              />
            </div>
            <span className={styles.dateSeparator}>～</span>
            <div className={styles.dateRange}>
              <label className={styles.filterLabel}>{$t("global-1688-ai-app.seller-center.credit-management.UsageDetails.endTime", "结束时间")}</label>
              <DatePicker
                className={styles.dateInput}
