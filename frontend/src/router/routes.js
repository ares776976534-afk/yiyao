...
export const routeConfig = [
  ...
  { path: ROUTES.CANDIDATES, component: lazy(() => import('../pages/CandidateManage')), meta: { title: '候选人管理' } },
  { path: ROUTES.WEB_CRAWLER, component: lazy(() => import('../pages/WebCrawler')), meta: { title: '网页抓取' } },
